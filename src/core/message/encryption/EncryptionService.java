package core.message.encryption;
...
public class EncryptionService 
{
	...
	public static JSONObject Encryption(String messageString) 
	{
		...
		try {
			...
			byte[] encodedData = RSACoder.encryptByPrivateKey(key, ConfigService.GetString("SecretKeyConfig", "RSA_private_key", ""));
	...
	public static JSONObject decryption(JSONObject EncryptionJson) 
	{
		...
		try {
			...
			desKey = new String(RSACoder.decryptByPrivateKey(data, ConfigService.GetString("SecretKeyConfig", "RSA_private_key", "")));
